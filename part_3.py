...
class part_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "part_3")
        ...
        self._mod_selector_options = [0, 1]
        # Create the labels list
        self._mod_selector_labels = ['NBFM', 'AM']
        ...
        self.top_layout.addWidget(self._mod_selector_tool_bar)
        ...
        self.blocks_selector_0 = blocks.selector(gr.sizeof_gr_complex*1,mod_selector,0)
        self.blocks_selector_0.set_enabled(True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_float_to_complex_1 = blocks.float_to_complex(1)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.blocks_add_const_vxx_0 = blocks.add_const_ff(1)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 10, 0.8, 0.2, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 0.5, 0, 0)
        ...
        self.connect((self.analog_nbfm_tx_0, 0), (self.blocks_selector_0, 0))
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_float_to_complex_1, 0))
    ...
    def set_mod_selector(self, mod_selector):
        ...
        self._mod_selector_callback(self.mod_selector)
        self.blocks_selector_0.set_input_index(self.mod_selector)




def main(top_block_cls=part_3, options=None):
