...
class integration(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.analog_const_source_x_0_0_0, 0), (self.blocks_float_to_complex_1, 1))
        ...
        self.connect((self.epy_block_0, 0), (self.analog_nbfm_tx_0_0, 0))
        self.connect((self.epy_block_0, 0), (self.blocks_add_const_vxx_0, 0))
        self.connect((self.epy_block_0, 1), (self.blocks_float_to_complex_1, 0))
